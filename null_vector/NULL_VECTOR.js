...
function findWasmBinary() {
    return locateFile('NULL_VECTOR.wasm');
}
...
// Begin JS library code
  ...
  var _emwgpuSetLabel = (ptr, data, length) => {
  ...
  var _wgpuAdapterGetFeatures = (adapterPtr, supportedFeatures) => {
      var adapter = WebGPU.getJsObject(adapterPtr);
      ...
      for (const feature of adapter.features) {
        ...
        if (featureEnumValue >= 0) {
          HEAP32[(((featuresPtr)+(offset))>>2)] = featureEnumValue;
          offset += 4;
          numFeatures++;
        }
      };
      HEAPU32[(((supportedFeatures)+(4))>>2)] = featuresPtr;
      HEAPU32[((supportedFeatures)>>2)] = numFeatures;
    };
  ...
  var _wgpuInstanceGetWGSLLanguageFeatures = (instance, supportedFeatures) => {
      // Always allocate enough space for all the features, though some may be unused.
  ...
  var _wgpuQuerySetDestroy = (querySetPtr) => {
  ...
  var _wgpuRenderPassEncoderBeginOcclusionQuery = (passPtr, queryIndex) => {
      assert(queryIndex >= 0);
      var pass = WebGPU.getJsObject(passPtr);
  ...
  var _wgpuRenderPassEncoderEndOcclusionQuery = (passPtr) => {
      var pass = WebGPU.getJsObject(passPtr);
...
var wasmImports = {
  ...
  /** @export */
  emwgpuSetLabel: _emwgpuSetLabel,
  /** @export */
  ...
  /** @export */
  wgpuCommandEncoderResolveQuerySet: _wgpuCommandEncoderResolveQuerySet,
  /** @export */
  ...
  /** @export */
  wgpuDeviceCreateQuerySet: _wgpuDeviceCreateQuerySet,
  /** @export */
  ...
  /** @export */
  wgpuInstanceGetWGSLLanguageFeatures: _wgpuInstanceGetWGSLLanguageFeatures,
  /** @export */
  ...
  /** @export */
  wgpuRenderPassEncoderBeginOcclusionQuery: _wgpuRenderPassEncoderBeginOcclusionQuery,
  /** @export */
  ...
  /** @export */
  wgpuRenderPassEncoderEndOcclusionQuery: _wgpuRenderPassEncoderEndOcclusionQuery,
  /** @export */
...
var _emwgpuCreateExternalTexture = createExportWrapper('emwgpuCreateExternalTexture', 1);
...
var _emwgpuImportBuffer = createExportWrapper('emwgpuImportBuffer', 1);
